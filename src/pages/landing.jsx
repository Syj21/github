...
// @ts-ignore;
import { Sparkles, Compass, Calendar, Users, MapPin, Star, ArrowRight } from 'lucide-react';
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={handleStartExplore} className="bg-white text-[#D4A574] px-8 py-4 rounded-full font-bold text-lg hover:bg-[#FDF8F3] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1" style={{
              fontFamily: 'Noto Sans SC, sans-serif'
            }}>
              开始探索
              <ArrowRight className="inline ml-2 w-5 h-5" />
            </button>
            <button onClick={handleStartExplore} className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300" style={{
              fontFamily: 'Noto Sans SC, sans-serif'
            }}>
              了解更多
            </button>
